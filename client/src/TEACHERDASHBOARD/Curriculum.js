...
//     axios
//       .post("/api/v1/adminRoute/createCurriculum", formDataToSend, {
...
const Api_GetAll = "/api/v1/adminRoute/getAllCurriculum";
const Delete_API ="/api/v1/adminRoute/deleteCurriculum";
...
const Curriculum = () => {
  ...
  useEffect(() => {
    axios.get("/api/v1/adminRoute/getAllCurriculum", {
      withCredentials: true,
    })
    .then((response) => {
  ...
  const handleDeleteCurriculum = (index) => {
    ...
    axios
      .delete("/api/v1/adminRoute/deleteCurriculum/" + curriculumId, {
        withCredentials: true,
      })
      .then(() => {

...
const Lectures = () => {
  ...
  useEffect(() => {
    axios.get(`api/v1/timeTable/getClassTimeTable?className=${data.classTeacher}&section=${data.section}` , {
  ...
  const handleSubmit = async () => {
      ...
      await axios
      .post("api/v1/timeTable/createClassTimeTable", formattedTimetable, {
        withCredentials: true,
      })
      .then(() => {
  ...
  const handleDelete = async() => {
    ...
    // api/v1/timeTable/deleteClassTimeTable/65449334131ddb58cb6de7f6
    await axios
      .delete(`api/v1/timeTable/deleteClassTimeTable/${timetableId}`, {
        withCredentials: true,
      })
      .then(() => {

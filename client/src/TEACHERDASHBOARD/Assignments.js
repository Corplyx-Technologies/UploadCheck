...
const Api_Create = "/api/v1/adminRoute/createAssignment";
const Api_Update = "/api/v1/adminRoute/updateAssignment/";
const Api_GetAssiignment = "/api/v1/adminRoute/getAllAssignment";
const Api_GetAll ="/api/v1/adminRoute/getAllClass";
const API_DELETE = "/api/v1/adminRoute/deleteAssignment/6538e0fb0c6aa38bbddec27b";
...
const Assignments = () => {
 ...
 const [showAssignment, setShowAssignment] = useState(false);
  ...
  useEffect(() => {
    axios.get("/api/v1/adminRoute/getAllClass", {
      withCredentials: true,
    })
    .then((response) => {
  ...
  useEffect(() => {
    axios.get("/api/v1/adminRoute/getAllAssignment", {
      withCredentials: true,
    })
    .then((response) => {
  ...
  const handleDeleteAssignment = (index) => {
    ...
    axios
      .delete("/api/v1/adminRoute/deleteAssignment/" + assignmentId, {
        withCredentials: true,
      })
      .then(() => {
